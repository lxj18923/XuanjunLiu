export default {
  ...
  'menu.Dashboard.Statistics': '数据统计',
  ...
  'menu.User-Management.Permission': '权限管理',
  'menu.User-Management.Info': '用户信息管理',
  'menu.Corpus Annotation': '语料库标注',
  'menu.Corpus Annotation.Annotation': '标注',
  'menu.Corpus Annotation.Select Annotation': '选择标注',
  'menu.Corpus Annotation.proofreading': '校对',
  'menu.Corpus Annotation.Annotation Result List': '标注结果列表',
  'menu.Corpus Annotation.Search': '语料搜索',

  'menu.Corpus Annotation.Upload': '上传语料',

  'menu.Corpus Annotation.Message': '留言',
  'menu.Corpus Annotation.triad': '三元组',
  'menu.account': '个人页',
  ...
  'app.analysis.today': '今日标注数量',
  'app.analysis.week': '本周标注数量',
  'app.analysis.total': '总标注数量',


  'app.statistics.overall':'总体标注趋势',
  'app.statistics.overall.tip':'展示前7天每日标注数据总量，每天零点清算，凌晨四点更新。',
  'app.statistics.users':'用户标注情况',
  'app.statistics.users.tip':'展示每个标注用户的具体标注情况，按总标注数量降序排序，每天凌晨四点清算并更新。',
  'app.statistics.form.userId':'用户Id',
  'app.statistics.form.userName':'用户名',
  'app.statistics.form.lastMarkdate':'最后标注日期',
  'app.statistics.form.countDaily':'当日标注数量',
  'app.statistics.form.countWeek':'过去7天标注数量',
  'app.statistics.form.countTotal':'总标注数量',


  'app.role':'角色管理',
  'app.role.form.name':'角色名称',
  'app.role.form.operation.deploy.title':'角色配置',
  'app.role.form.operation.deploy.base':'基本信息',
  'app.role.form.operation.deploy.permissions':'配置权限',
  'app.role.form.operation.deploy.range':'设定数据范围',


  'app.permission':'权限管理',
  'app.permission.form.resourceName':'资源名称',
  'app.permission.form.type':'类型',
  'app.permission.form.authorityValue':'权限值',
  'app.permission.form.url':'接口',
  'app.permission.form.requestMethod':'请求方法',
  'app.permission.form.superior':'上级资源',
  'app.permission.form.operation.deploy.title':'权限配置',


  'app.info':'用户信息管理',
  'app.info.form.create.title':'添加用户',
  'app.info.form.userId':'用户编号',
  'app.info.form.loginName':'登录名称',
  'app.info.form.password':'密码',
  'app.info.form.language':'语言',
  'app.info.form.name':'姓名',
  'app.info.form.studentId':'学号',
  'app.info.form.major':'专业',
  'app.info.form.operation.deploy.title':'用户设置',


  'app.label.systemLabel':'系统标注的结果：',
  'app.label.tip':'该句可能含有复合词，请仔细校对！',
  'app.label.skip':'跳过',
  'app.label.submit':'提交',
  'app.label.submit.error':'请注意输入格式（词性后面加空格，除最后一个，注意需添加每个词的词性）',
  'app.label.submit.tip':'不可重复提交哦~',
  'app.label.submit.success':'提交成功',
  'app.label.delete':'删除',
  'app.label.delete.tip':'请确保语料有问题再执行此操作',
  'app.label.dictionary':'词性字典：',
  'app.label.search.placeholder':'请输入词语',
  'app.label.search.error':'查无该词词性',
  'app.label.search.partOfSpeech':' 词性为：',
  'app.label.search.count':'标注量：',
  'app.label.userResult.left':'用户',
  'app.label.userResult.right':'标注结果：',


  'app.markList':'标注结果列表',
  'app.markList.form.sentence':'原句',
  'app.markList.form.systemLabel':'系统分词',
  'app.markList.form.language':'语言',
  'app.markList.form.source':'来源',
  'app.markList.form.status':'状态',
  'app.markList.form.markContent':'用户标注内容',
  'app.markList.form.username':'用户名',
  'app.markList.form.markDate':'标注时间',
  'app.markList.form.modify':'修改',
  'app.markList.form.modify.title':'修改标注内容',

  'app.markList.status.unlabelled':'未标注',
  'app.markList.status.labelledOnce':'标注一次',
  'app.markList.status.failed':'交叉验证失败',
  'app.markList.status.three':'标注三次',
  'app.markList.status.success':'交叉验证成功',
  'app.markList.status.finish':'校对处理完成',
  'app.markList.status.notCross':'未进行交叉验证',
  'app.markList.status.null':'无',
  ...
  'app.comment':'留言列表',
  'app.comment.form.content':'留言内容',
  'app.comment.form.username':'用户名',
  'app.comment.form.postDate':'留言时间',
  'app.comment.form.operation.read':'查看',
  'app.comment.message':'留言',
  'app.comment.addMessage':'添加回复',
  'app.comment.addMessage.success':'成功',
  'app.comment.modal.detailMessage':'留言详情',
  'app.comment.modal.reply':'回复',
  'app.comment.modal.detailMark':'标注详情',
  'app.comment.modal.allReply':'所有回复',




  'app.modal.previous':'上一步',
  'app.modal.next':'下一步',
  'app.modal.cancel':'取消',
  'app.modal.ok':'完成',

  'app.form.create':'新建',
  'app.form.create.title':'新建角色',
  'app.form.delete':'删除',
  'app.form.placeholder':'请输入',
  'app.form.operation':'操作',
  'app.form.operation.deploy':'配置',
  'app.form.operation.deploy.success':'配置成功！',
  'app.form.operation.delete.success':'删除成功！',
  'app.form.create.successMessage':'添加成功！',
  'app.form.selected':'项已选择',
  'app.form.selected.total':'总计',
  'app.form.selected.empty':'清空',
